...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `blood_donate` . `donar list` (`name`, `id`, `department`, `batch`, `blood_group`, `gender`, 
    `age`, `weight`, `last_donate`, `phone_number`, `present_address`, `dt`) VALUES ('$name', 
    '$id', '$department', '$batch', '$blood_group', '$gender', '$age', '$weight', '$last_donate', '$phone_number', '$present_address', current_timestamp());";
        ...
        <section>
                ...
                <div class="nav_div">
                    ...
                    <div class="nav_list">
                        <ul>
                            ...
                            <a href="donarReq.php"><li><p class="list active">Register as a Donor</p></li></a>
            ...
            <div class="right_part">
                ...
                <div class="right_part_blur">
                    ...
                    <form class="don_form" action="donarReq.php" method="post">
                        <h1>Donor Registration</h1>
                        <?php
                            if($insert == true)
                                echo "<p class='submitMsg'>Thanks for submitting your form.</p>"
                        ?>
                        <label for="name"><p>Full Name</p><span>:</span>
                            <input type="text" id="name" name="name" placeholder="Your Name" required>
                        </label>
                        <label for="id"><p>Student Id</p><span>:</span>
                            <input type="number" id="id" name="id" placeholder="Enter ID" required>
                        </label>
                        <label for="department"><p>Department</p><span>:</span>
                        ...
                        <label for="batch"><p>Batch</p><span>:</span>
                            <input type="number" id="batch" name="batch" placeholder="Enter Batch" required>
                        </label>
                        <label for="blood_group"><p>Blood Group</p><span>:</span>
                        ...
                        <label for="gender"><p>Gender</p><span>:</span>
                            <div class="for_gender">
                            <input type="radio" id="male" name="gender" value="Male">Male
                            <input type="radio" id="female" name="gender" value="Female">Female
                            <input type="radio" id="others" name="gender" value="Others">Others</div>
                        </label>
                        <label for="age"><p>Age</p><span>:</span>
                            <input type="number" name="age" id="age" placeholder="Your Age" required>
                        </label>
                        <label for="weight"><p>Weight</p><span>:</span>
                            <input type="number" name="weight" id="weight" placeholder="Your Weight" required>
                        </label>
                        <label for="last_donate"><p>Last Donate</p><span>:</span>
                            <input type="date" name="last_donate" id="last_donate">
                        </label>
                        <label for="phone_number"><p>Phone Number</p><span>:</span>
                            <input type="number" name="phone_number" id="phone_number" placeholder="Your Number" required>
                        </label>
                        <label for="present_address"><p>Present Address</p><span>:</span>
                            <textarea name="present_address" id="present_address" placeholder="Enter Address" required></textarea>
                        </label>
